...
namespace SpecFlowProject1.PageObjects
{
    public class GuestLogin
    {
        ...
        public IWebElement Loginbutton => _browser.FindElement(By.Id("login-button"));
        ...
        public void EnterTheGuestPass(string strCode)
        {
            ...
            wait.Until(e => e.FindElement(By.Id("email-login"))); // explicit wait for element to be found before running test. Refer to cheatsheet
